            ...
            <div class="mt-3 ms-3 me-3 " style="color: blue"> <i class="bi bi-person"></i>Informacion personal del paciente</div>
                <div class="card mt-3 ms-3 me-3">
                    <div class="card m-5 style="width: 400px">
                        <form action="{{route('editar',$datos->id)}}" class="m-5" method="GET">
                            @method('POST')
                            @csrf
                            <label for="curp" class="form-label">curp*</label>
                            <input type="text" id="curp" name="curp" class="form-control" value="{{$datos->curp}}">
                            <label for="curp" class="form-label">paciente*</label>
                            <input type="text" id="paciente" name="paciente" class="form-control" value="{{$datos->paciente}}">
                            <label for="curp" class="form-label">Institucion*</label>
                            <input type="text" id="institucion" name="institucion" class="form-control" value="{{$datos->institucion}}">
